...
const Register = () => {
  ...
  return (
    <>
      <div className="card py-24 bg-orange-50 text-black">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
          ...
          <div className="form-control mt-6">
            <input className="md:px-8  bg-[#877a52] hover:bg-[#d3aa2f] rounded-lg duration-700 p-2 md:py-3 text-white" type="submit" value="Register" />
          </div>
        </form>
